...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[[UIAlertView alloc] initWithTitle:@"Directions"
                                message:@"1. Copy the \"Copy Me\" Text.\n2. Paste text in the red rectangle, click the 'show red' button\n3. Paste text in the blue rectangle, click the 'show blue' button.\nNotice that red is wrapped in <font size='3'>, but blue is not.\n\nThis happens in iOS6+, but not in iOS5.1-"
                               delegate:nil
